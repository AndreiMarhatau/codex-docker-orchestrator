...
function buildCodexArgs({ prompt, model, reasoningEffort, resumeThreadId, developerInstructions }) {
  ...
  if (developerInstructions) {
    args.push('-c', `developer_instructions=${JSON.stringify(developerInstructions.trim())}`);
  }
  if (resumeThreadId) {
