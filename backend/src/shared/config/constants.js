...
const DEFAULT_CONTEXT_REPOS_TEMPLATE_FILE = path.join(REPO_ROOT, 'ORCHESTRATOR_CONTEXT_REPOS_TEMPLATE.md');
const DEFAULT_ATTACHMENTS_TEMPLATE_FILE = path.join(REPO_ROOT, 'ORCHESTRATOR_ATTACHMENTS_TEMPLATE.md');
const DEFAULT_AUTO_REVIEW_FIX_PROMPT_TEMPLATE_FILE = path.join(
  REPO_ROOT,
  'ORCHESTRATOR_AUTO_REVIEW_FIX_PROMPT_TEMPLATE.md'
);
...
module.exports = {
  ...
  DEFAULT_AUTO_REVIEW_FIX_PROMPT_TEMPLATE_FILE,
  COMMIT_SHA_REGEX,
