...
const DEFAULT_ORCH_SKILL_TEMPLATE = path.join(__dirname, '..', '..', '..', 'ORCHESTRATOR_SKILL.md');
const DEFAULT_HOST_DOCKER_SKILL_FILE = path.join(
  __dirname,
  '..',
  '..',
  '..',
  'ORCHESTRATOR_SKILL_HOST_DOCKER.md'
);
