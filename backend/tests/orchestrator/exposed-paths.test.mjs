...
describe('task exposed paths', () => {
  it('returns container mount paths without preparing task-home aliases', async () => {
    ...
    const taskId = 'task-1';
    const exposed = await orchestrator.prepareTaskExposedPaths(taskId, { contextRepos: [] });
