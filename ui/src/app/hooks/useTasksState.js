...
function useTasksState({ envs, refreshAll, setError, setLoading, tasks }) {
  ...
  const actions = useTaskActions({
    ...
    resumeRepoReadOnly: detail.resumeRepoReadOnly,
    ...
    setResumeRepoReadOnly: detail.setResumeRepoReadOnly,
    setResumeRepoReadOnlyTouched: detail.setResumeRepoReadOnlyTouched,
