...
function useTasksState({ enabled, envs, refreshAll, setError, setLoading, tasks }) {
  ...
  const actions = useTaskActions({
    ...
    resumeGoalObjective: detail.resumeGoalObjective,
    initialResumeGoalObjective: detail.initialResumeGoalObjective,
    ...
    setResumeGoalObjective: detail.setResumeGoalObjective,
    setInitialResumeGoalObjective: detail.setInitialResumeGoalObjective,
